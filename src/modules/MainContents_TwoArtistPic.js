...
const MainContents_TwoArtistPic = (props) => {
    return (
        <div className = "twoArtistPic">
          <Second_Title secondTitle="ABOUT THE ARTIST"></Second_Title>
            <Row className="mainSection_Row">
                <Col xl={{span:2, offset:2}} lg={{span:3, offset:1}} md={{span:5, offset:1}}  xs={{span:4, offset:1}} style={{marginRight:"0px",paddingRight:"0px"}}>
                    <img src={props.pic1} className="mainSection_Img2"></img>

                </Col>
                <Col xl={{span:2, offset:0}} lg={{span:3, offset:0}}md={{span:5, offset:0}}  xs={{span:4, offset:0}}  style={{marginRight:"0px",paddingRight:"0px"}}>
...
export default MainContents_TwoArtistPic;
