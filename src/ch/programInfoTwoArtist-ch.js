        ...
        <div style={{marginBottom:"100px"}}>
            {/*}<Row className="PI-contents" style={{borderTop: "1px solid " + props.color }}>*/}
                <Col lx={{span:8, offset:2}} lg={{span:10, offset:1}} md={{span:10, offset:1}} sm={{span:10, offset:1}}  xs={{span:8, offset:2}}>
                    <Row><p className="PI-subtitle-ch" style={{fontFamily:"sofia-pro, san-serif"}}>{props.subtitle}</p></Row>
                    <Row><h1 className="PI-title_twoArtist-ch" style={{fontFamily:"sofia-pro, san-serif"}}>{props.title}</h1></Row>
                    <Row className="PI-secondlast">
                        <Col className="PI-artist-two-ch"><p className = "PI-Artist-p" style={{fontFamily:"sofia-pro, san-serif"}}>{props.artistitle1}{props.artistName1}</p></Col>
                    </Row>
                    <Row className="PI-last">
                        <Col className="PI-artist-two-ch"><p className = "PI-Artist-p" style={{fontFamily:"sofia-pro, san-serif"}}>{props.artistitle2}{props.artistName2}</p></Col>
