...
function PaulsApple() {
    return (
        <div>
           ...
           <div className="paulMiddleSection">
               <ProgramInfo subtitle="Behind the Masks" title="PAUL'S APPLES" artistName="Lady Hao Hao" url="https://www.facebook.com/sharer/sharer.php?u=https://www.acsea.ca/"></ProgramInfo>
           </div>

            <div className="paulBottomSection">
                ...
                {/* <div className="column1">
                    <p className="p-l">Virus particles can remain on sufaces for hours...</p>
                </div>
                ...
                <div className="logos1">
                    <SocialIcon
                        url="https://www.facebook.com/" bgColor="#111111" className="icon"/>
                    <SocialIcon
                        url="https://www.instagram.com/" bgColor="#111111" className="icon"/>
                    <SocialIcon
                        url="https://twitter.com/explore" bgColor="#111111" className="icon"/>
                </div>

                <div className="logos2">
                    <SocialIcon
                        url="https://www.facebook.com/" bgColor="#111111" className="icon" style={{ height: 40, width: 40 }}/>
                    <SocialIcon
                        url="https://www.instagram.com/" bgColor="#111111" className="icon" style={{ height: 40, width: 40 }}/>
                    <SocialIcon
                        url="https://twitter.com/explore" bgColor="#111111" className="icon" style={{ height: 40, width: 40 }}/>
                </div>

                <div className="logos3">
                    <SocialIcon
                        url="https://www.facebook.com/" bgColor="#111111" className="icon" style={{ height: 30, width: 30 }}/>
                    <SocialIcon
                        url="https://www.instagram.com/" bgColor="#111111" className="icon" style={{ height: 30, width: 30 }}/>
                    <SocialIcon
                        url="https://twitter.com/explore" bgColor="#111111" className="icon" style={{ height: 30, width: 30 }}/>
                </div> */}
            </div>
        </div>
    );
